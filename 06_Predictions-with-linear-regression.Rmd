...
```{r, echo=FALSE, out.width="50%", fig.align='center', fig.cap="Done. We are all friendly neighbourhood statisticians now"}
knitr::include_graphics("images/Linear_regression_in_R/we_are_all_friendly.jpg")
```
