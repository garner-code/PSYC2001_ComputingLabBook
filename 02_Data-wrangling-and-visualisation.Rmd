...
> Now complete the next lines in your script so that they match the below lines of code, and run each line, one at a time.
...
- The **datatype**: **chr** for **`id`**, **int** for **urban**, and **num** for all other variables
...
```{r, echo=FALSE, out.width="50%", fig.align='center', fig.cap="Good work. You are done. Take a break."}
