...
You should have downloaded the files you need for this week's computing lab tutorial from the course Moodle. Unzip the folder you have downloaded, move the folder to somewhere sensible on the computer, e.g. from 'Downloads' to 'Documents'. Ask your tutor if you are unsure about any of those steps. 
