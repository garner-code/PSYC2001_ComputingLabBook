...
::: {style="border-left: 4px solid #32a2a8; background-color: #cbf3f5; padding: 10px; margin: 10px 0;"}
...
Importantly, objects can be involved in calculations and can interact with each other. For example, copy and paste this code into your script and run it. Check your answer matches what you see below.
...
You will see the below lines of code in your script. Run them and make sure you get the same answers as you see here.
